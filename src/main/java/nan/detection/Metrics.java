...
public class Metrics {
    ...
    public Metrics(String timeWindow, int record_creation_num, int ntp_num, double ntp_to_flow_ratio,
                   ...
                   int syn_src_less_20, int syn_src_large_20, int syn_dst_less_5, int syn_dst_less_10,
                   int syn_dst_less_20, int syn_dst_large_20, double syn_src_less_5_ratio, double syn_src_less_10_ratio,
                   ...
                   double ack_to_tcp_ratio, int ack_src_less_5, int ack_src_less_10, int ack_src_less_20,
                   int ack_src_large_20, int ack_dst_less_5, int ack_dst_less_10, int ack_dst_less_20,
                   int ack_dst_large_20, double ack_src_less_5_ratio, double ack_src_less_10_ratio,
                   double ack_src_less_20_ratio, double ack_src_large_20_ratio, double ack_dst_less_5_ratio,
                   double ack_dst_less_10_ratio, double ack_dst_less_20_ratio, double ack_dst_large_20_ratio,
                   String ack_src_top_20, String ack_dst_top_20, int fin_num, double fin_to_flow_ratio,
                   double fin_to_tcp_ratio, int fin_src_less_5, int fin_src_less_10, int fin_src_less_20,
                   int fin_src_large_20, int fin_dst_less_5, int fin_dst_less_10, int fin_dst_less_20,
                   ...
                   String udp_src_top_20, String udp_dst_top_20, int icmp_num, double icmp_to_flow_ratio,
                   int icmp_src_less_5, int icmp_src_less_10, int icmp_src_less_20, int icmp_src_large_20,
                   int icmp_dst_less_5, int icmp_dst_less_10, int icmp_dst_less_20, int icmp_dst_large_20,
                   double icmp_src_less_5_ratio, double icmp_src_less_10_ratio, double icmp_src_less_20_ratio,
                   double icmp_src_large_20_ratio, double icmp_dst_less_5_ratio, double icmp_dst_less_10_ratio,
                   double icmp_dst_less_20_ratio, double icmp_dst_large_20_ratio, String icmp_src_top_20, String icmp_dst_top_20,
                   int inval_flag_num, double inval_flag_to_flow_ratio, double inval_flag_to_tcp_ratio, int inval_flag_src_less_5,
                   int inval_flag_src_less_10, int inval_flag_src_less_20, int inval_flag_src_large_20, int inval_flag_dst_less_5,
                   int inval_flag_dst_less_10, int inval_flag_dst_less_20, int inval_flag_dst_large_20, double inval_flag_src_less_5_ratio,
                   double inval_flag_src_less_10_ratio, double inval_flag_src_less_20_ratio, double inval_flag_src_large_20_ratio,
                   double inval_flag_dst_less_5_ratio, double inval_flag_dst_less_10_ratio, double inval_flag_dst_less_20_ratio,
                   double inval_flag_dst_large_20_ratio, String inval_flag_src_top_20, String inval_flag_dst_top_20) {
    ...
    public String toString() {
        return "timeWindow=" + timeWindow + "|record_creation_num=" + record_creation_num + "|ntp_num="
